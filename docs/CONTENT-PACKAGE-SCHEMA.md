...
| `text-main.yaml` / `text-extra.yaml` | абзацы `body[]`, склеенные в plain text и разрезанные на предложения | `ReadingText` → /module и /session (шаг `reading`) |
